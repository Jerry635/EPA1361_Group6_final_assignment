...
def get_model_for_problem_formulation(problem_formulation_id):
    ...
    # Disaggregate over time:
        ...
        for n in function.planning_steps:
            ...
            variable_names_____.extend(['{}_Expected Number of Deaths {}'.format(dike, n) 
                                        for dike in function.dikelist[2:len(function.dikelist)-1]])
            variable_names______.extend(['{}_Expected Number of Deaths {}'.format(dike, n) 
                                         for dike in function.dikelist[len(function.dikelist)-1]])
        ...
        dike_model.outcomes = [
                ...
                ScalarOutcome('Expected Number of Deaths Upstream Gelderland',
                          variable_name=[var for var in variable_names____],
                          function=sum_over, kind=direction),
            
                ScalarOutcome('Expected Number of Deaths Downstream Gelderland',
                          variable_name=[var for var in variable_names_____],
                          function=sum_over, kind=direction),
            
                ScalarOutcome('Expected Number of Deaths Overijssel',
